...
def main():
    ...
    # Datos de ejemplo con contenido más extenso para las columnas 4 y 5
    sample_data = [
        [
            "A1",
            "B1",
            "C1",
            ["Información detallada del elemento 1", "Descripción técnica completa", "Especificaciones adicionales"],
            ["Log del proceso 1", "Estado: Completado exitosamente", "Tiempo de ejecución: 2.5 segundos",
        ...
        [
            ...
            "B2",
            "C2",
            ["Datos del segundo elemento", "Configuración personalizada aplicada"],
            ["Log del proceso 2", "Estado: En progreso", "Advertencias detectadas en validación"]
        ],
        [
            "A3",
            "B3",
            "C3",
            ["Elemento 3 con múltiples propiedades", "Configuración avanzada", "Parámetros específicos del sistema"],
            ["Proceso iniciado correctamente", "Validación de entrada exitosa", "Procesando datos...",
        ...
        [
            ...
            "B4",
            "C4",
            ["Descripción extensa del cuarto elemento", "Incluye metadatos y referencias"],
            ["Error detectado en la línea 45", "Intentando recuperación automática", "Proceso reiniciado",
        ...
        [
            ...
            "B5",
            "C5",
            ["Último elemento de la muestra"],
            ["Log del proceso final", "Todas las validaciones completadas", "Sistema listo para producción"]
        ]
    ]

    # Crear y mostrar el diálogo
    dialog = TableDialog(sample_data)
